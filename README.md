...
- Led mobile and web app development, including **survey apps, government office optimization, and executive dashboards**.
...
📍 *March 2019 – August 2021 | Abu Dhabi*
...
- Developed a mobile app for inspectors to conduct **15 types of inspections** (building/shop inspections, noise pollution, abandoned vehicles).
- Integrated **geofencing, inspector location tracking, and file uploads**.
- Implemented **Emirates ID scanning (Google Vision API)**, **camera object detection (OpenCV)**, and **ArcGIS Esri maps**.
...
📍 *March 2018 - March 2019 | Abu Dhabi*

- Developed **Performance Dashboard Software** to measure department performance based on KPIs.
- Built **secure email communication software for embassies** and a **media reporting system**.
- Developed **a department performance monitoring application** with KPI tracking and graphical performance visualization.
...
- Led a team of **5 developers**, overseeing application development and support.
- Provided **technical leadership** in database architecture and software design.
- Managed **application server, firewall supervision, and front-end architecture**.
- Conducted **team administration, performance monitoring, and technical interviews**.

#### Key Projects
- **Manufacturing ERP Software**: Business management solution for **Finance, Sales, Inventory, Procurement, HR & Payroll**.
- **Cargo/Parcel Management Software**: Shipment tracking and logistics with **mobile apps for Android & iOS**.
- **Forex Exchange Software**: Comprehensive platform for **remittance and currency exchange operations**.

---

### ESAT  
**Software Developer | Web Application & ERP Development**  
📍 *Feb 2014 - July 2016 | Abu Dhabi*
